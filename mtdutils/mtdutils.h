...
/*for mmcblk write function*/
#define HEADER_SIZE 2048  // size of header to compare for equality
#define BLK_SIZE 512
#define MMCBLK0 "/dev/block/mmcblk0"
#define MMCBLK0P1 "/dev/block/mmcblk0p1"
#define MMCBLK0P2 "/dev/block/mmcblk0p2"
#define MMCBLK0P3 "/dev/block/mmcblk0p3"
#define MMCBLK0P4 "/dev/block/mmcblk0p4"
struct mmc_image_t
{
	char *name;
	char *mmcblk;
...
typedef struct mmc_image_t mmc_images;
